defmodule GreenMarketWeb.AdminAuth do
  import Plug.Conn
  ...
  def log_out_admin(conn) do
    ...
    admin_token && Admin_accounts.delete_session_token(admin_token)

    if live_socket_id = get_session(conn, :live_socket_id) do
      GreenMarketWeb.Endpoint.broadcast(live_socket_id, "disconnect", %{})
    end
  ...
  def fetch_current_admin(conn, _opts) do
    ...
    admin = admin_token && Admin_accounts.get_admin_by_session_token(admin_token)
