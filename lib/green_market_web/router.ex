defmodule GreenMarketWeb.Router do
  alias CategoryController
  alias ProductController
  use GreenMarketWeb, :router

  import GreenMarketWeb.AdminAuth

  import GreenMarketWeb.UserAuth

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, {GreenMarketWeb.LayoutView, :root}
  ...
  if Mix.env() in [:dev, :test] do
    ...
    scope "/" do
      ...
      live_dashboard "/dashboard", metrics: GreenMarketWeb.Telemetry
    end
  end
