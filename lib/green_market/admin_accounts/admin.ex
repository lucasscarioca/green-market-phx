defmodule GreenMarket.Admin_accounts.Admin do
  use Ecto.Schema
  ...
  defp validate_email(changeset) do
    ...
    |> unsafe_validate_unique(:email, GreenMarket.Repo)
  ...
  """
  def valid_password?(%GreenMarket.Admin_accounts.Admin{hashed_password: hashed_password}, password)
